...
const App = () => {
  ...
  const [checkTV, setCheckTV] = useState(false)
                ...
                return (
                  <div key={e._id} onClick={() => {
                    ...
                    <div className='flex justify-between items-center'>
                      <h2 className='w-36 font-semibold truncate font-sans'>{e.name}</h2>
                ...
                if (e.tmdb.type == 'movie' && count < 4) {
                  ...
                  return (
                    <div key={e._id} className='w-64 flex flex-col' onClick={() => {
                      nav(`/player/${e.tmdb.type}/${e.slug}/1`)
                    }}>
                      <img className='h-80 object-cover' src={`https://img.ophim.live/uploads/movies/${e.thumb_url}`} alt="" />
                      <h2 className='font-semibold text-center font-sans'>{e.name}</h2>
                    </div>
                  )
                }
